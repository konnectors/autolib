...
This konnector retrieves your bills from Autolib
...
The lead maintainer for this konnector is [@CPatchane](https://github.com/cpatchane)
...
Autolib (konnector) is developed by Cozy Cloud and distributed under the [AGPL v3 license][agpl-3.0].
